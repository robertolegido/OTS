...
#Create new instance
client = mqtt.Client("clienteserio")
...
print ("")
print ("2")
print("***** Subscribe to cosamuyseria/muymuyseria *****")
client.subscribe("cosamuyseria/muymuyseria")

#Publish in test message in topic"
print ("")
print ("3")
print("***** Publish in topic muyserio/muyserio *****")
client.publish("cosamuyseria/muyseria", "AMAZING")
#client.publish("cosamuyseria/muyseria", "AMAZING QoS 1", 1)
time.sleep(10)
